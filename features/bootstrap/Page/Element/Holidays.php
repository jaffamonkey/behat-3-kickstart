...
class Holidays extends Element
{
    ...
    */
    ...
    function calculateBankHolidays($yr)
    {
        ...
        // New year's:
        switch (date("w", strtotime("$yr-01-01 00:00:05"))) {
            case 6:
                $bankHols[] = "$yr-01-03";
                break;
            case 0:
        ...
        if ($yr == 1995) {
            ...
            switch (date("w", strtotime("$yr-05-01 00:00:05"))) {
                case 0:
                    $bankHols[] = "$yr-05-02";
                    break;
                case 1:
        ...
        // Summer Bank Holiday:
        switch (date("w", strtotime("$yr-08-31 00:00:05"))) {
            case 0:
                $bankHols[] = "$yr-08-25";
                break;
            case 1:
        ...
        // Christmas:
        switch (date("w", strtotime("$yr-12-25 00:00:05"))) {
            case 5:
//            $bankHols[] = "$yr-12-25";
//            $bankHols[] = "$yr-12-26";
                $bankHols[] = "$yr-12-24";
